        ...
        <div class="new-story__header">
          <div class="container">
            ...
            <p class="new-story__header__description">
              Please fill out this form to create your own beautiful story, and share it with everyone.
            </p>
          </div>
        </div>
      </section>
        ...
        <div class="new-form__container">
          <form id="new-form" class="new-form">
            <div class="form-control">
              <label for="description-input" class="new-form__description__title">The Story</label>
              <div class="new-form__description__container">
                <textarea
                  id="description-input"
                  name="description"
                  placeholder="Describe your amazing story here with clarity."
                ></textarea>
              </div>
            </div>
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Picture</label>
              <div id="documentations-more-info">You can include some pictures from your story.</div>
            ...
            <div class="form-control">
              <div class="new-form__location__title">It's your location or your story's location</div>
